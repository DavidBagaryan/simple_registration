...
class Twig_Tests_Loader_FilesystemTest extends PHPUnit_Framework_TestCase
{
    public function testGetSourceContext()
    {
        ...
        $this->assertEquals('errors/login.html', $loader->getSourceContext('errors/login.html')->getName());
        $this->assertEquals(realpath($path.'/errors/login.html'), realpath($loader->getSourceContext('errors/login.html')->getPath()));
    }
    ...
    public function testPaths($basePath, $cacheKey, $rootPath)
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSourceContext('login.html')->getCode());
        $this->assertEquals("path (final)\n", $loader->getSourceContext('@__main__/login.html')->getCode());
        $this->assertEquals("named path (final)\n", $loader->getSourceContext('@named/login.html')->getCode());
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        // prime the cache for login.html in the named namespace
        $namedSource = $loader->getSourceContext('@named/login.html')->getCode();
        $this->assertEquals("named path\n", $namedSource);

        // get login.html from the main namespace
